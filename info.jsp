    ...
    <div style="width:80%;float: left;border: 5px dashed CornflowerBlue;">
        <div id="div1" style="display:block;">
            <div>
                ...
                <button class="btn btn-default" type="submit" style="font-family:verdana;margin-top:10px;color:LightSeaGreen;background:Moccasin;border: hidden"><b>Edit</b></button>
            ...
            <div class="form-group" style="float: left;width: 90%;margin-left:50px;margin-right: 50px;color:LightSeaGreen">
